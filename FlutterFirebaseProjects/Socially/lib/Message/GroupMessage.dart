    ...
    return Scaffold(
      ...
      appBar: AppBar(
          actions: [
            IconButton(
              onPressed: () {
                Provider.of<GroupMessagingHelper>(context,listen: false).leaveGroup(context, widget.documentSnapshot.id);
              },
                  ...
                  children: [
                    Container(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(hintText: 'Type Here.....',hintStyle: TextStyle(
                            color: Colors.white
                          )),
                        )),
                    Padding(
                        ...
                        onPressed: () {
                          if (c.text != "") {
                            Provider.of<GroupMessagingHelper>(context,
                                    listen: false)
                                .sendMessage(context, widget.documentSnapshot, c);
                          }
                        },
